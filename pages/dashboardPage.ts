...
export default class DashboardPage {
    ...
    readonly disclosure_module : Locator;
    ...
    constructor(public page: Page) {
        ...
        this.disclosure_module = page.locator('[data-testid="module-disclosure"]');
    }
    ...
    async navigatestoDisclosureModule() {
        const disclosure_module_btn = this.disclosure_module
        await disclosure_module_btn.click({ timeout: 100000 });
